      ...
      <div className="bg-white rounded-2xl p-4 sm:p-5 border border-lime-200 shadow-sm">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base sm:text-lg font-black text-slate-800">Health Profile & Context</h2>
              <p className="text-xs text-slate-500 font-medium">Step 1 of 8 · Baseline Targets & Metabolic Calibration</p>
            </div>
          </div>
          <button
            onClick={() => {
            ...
            className="flex items-center gap-1 text-xs font-bold px-3 py-1.5 rounded-xl border border-lime-300 bg-lime-50 text-lime-800 hover:bg-lime-100 transition shadow-2xs"
          >
            {isEditing ? (
              <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2.5">
            {/* Metric 1: Age & Gender */}
            <div className="bg-white p-4 rounded-2xl border border-lime-200/80 shadow-sm">
              <div className="flex items-center gap-2 text-slate-500 text-xs font-medium mb-1">
                <Activity className="w-3.5 h-3.5 text-lime-600" />
                <span>Age & Gender</span>
              </div>
              <p className="text-base sm:text-lg font-black text-slate-800">{profile.age} yrs · {profile.gender}</p>
            ...
            <div className="bg-white p-4 rounded-2xl border border-lime-200/80 shadow-sm">
              ...
              {isEditing ? (
                ...
                <p className="text-base sm:text-lg font-black text-slate-800">{profile.heightCm} cm · {weight} kg</p>
              )}
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-2xl p-4 sm:p-5 border border-lime-200 shadow-sm space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[11px] font-semibold text-lime-700 bg-lime-50 px-2 py-0.5 rounded-md border border-lime-200">
                Active Calibration
              </span>
            </div>

            <div className="grid grid-cols-2 min-[420px]:grid-cols-4 gap-2.5 text-center pt-1">
              <div className="bg-lime-50/80 p-3 rounded-xl border border-lime-200 shadow-2xs">
                <span className="block text-[10px] uppercase font-bold text-lime-800">Protein</span>
                <span className="text-lg font-black text-lime-950">{profile.targetProteinG}g</span>
                <span className="text-[10px] text-lime-700 block font-medium">1.1g / kg</span>
              </div>
              <div className="bg-slate-50 p-3 rounded-xl border border-slate-200 shadow-2xs">
                ...
                <span className="text-lg font-black text-slate-800">{profile.targetCalories}</span>
                <span className="text-[10px] text-slate-400 block font-medium">kcal/day</span>
              </div>
              <div className="bg-slate-50 p-3 rounded-xl border border-slate-200 shadow-2xs">
                <span className="block text-[10px] uppercase font-bold text-slate-500">Carbs</span>
                <span className="text-lg font-black text-slate-800">{profile.targetCarbsG}g</span>
                <span className="text-[10px] text-slate-400 block font-medium">complex base</span>
              </div>
              <div className="bg-slate-50 p-3 rounded-xl border border-slate-200 shadow-2xs">
                <span className="block text-[10px] uppercase font-bold text-slate-500">Fat</span>
                <span className="text-lg font-black text-slate-800">{profile.targetFatG}g</span>
                <span className="text-[10px] text-slate-400 block font-medium">healthy lipids</span>
              </div>
            </div>
